...
plot "$1" using 4:(\$9/256) smooth csplines t 'Free Mb' ,\
     "$1" using 4:(\$10/256) smooth csplines t 'Cache Mb' ,\
     "$1" using 4:(\$11/256) smooth csplines t 'Dirty Mb' ,\
     "$1" using 4:(\$12/256) smooth csplines t 'Buff Mb' ,\
     "$1" using 4:(\$13/256) smooth csplines t 'Slab Mb' ;
